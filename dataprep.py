...
def main():
    filename = path.join("input_data", "playerstats2022norm.csv")
    norm_table_2022 = MyPyTable().load_from_file(filename)
    filename = path.join("input_data", "playerstats2022adv.csv")
    ...
    filename = path.join("input_data", "playerstats2021norm.csv")
    norm_table_2021 = MyPyTable().load_from_file(filename)
    filename = path.join("input_data", "playerstats2021adv.csv")
    ...
    filename = path.join("input_data", "playerstats2020norm.csv")
    norm_table_2020 = MyPyTable().load_from_file(filename)
    filename = path.join("input_data", "playerstats2020adv.csv")
    ...
    filename = path.join("input_data", "playerstats2019norm.csv")
    norm_table_2019 = MyPyTable().load_from_file(filename)
    filename = path.join("input_data", "playerstats2019adv.csv")
    ...
    filename = path.join("input_data", "playerstats2018norm.csv")
    norm_table_2018 = MyPyTable().load_from_file(filename)
    filename = path.join("input_data", "playerstats2018adv.csv")
